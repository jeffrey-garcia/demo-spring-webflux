...
public class DemoConsumerTests {
    ...
    public void verifyConsumerRx0() {
        ...
        }).accept((Flux<Message<DemoEntity>>) DemoConsumerAdviceInvocator.invokeReactive(inputFlux));
    ...
    public void verifyConsumerRx1() {
        ...
        }).accept((Flux<String>) DemoConsumerAdviceInvocator.invokeReactive(inputFlux));
    ...
    public void verifyConsumerRx2() {
        ...
        // emit the stream to consumer
        Flux<String> outputFlux = consumerRx2.apply((Flux<String>) DemoConsumerAdviceInvocator.invokeReactive(inputFlux));
    ...
    public void verifyConsumer0() {
        ...
        }).accept(DemoConsumerAdviceInvocator.invoke(input));
    }
    ...
    public void verifyConsumer1() {
        ...
        // emit the data to consumer
        String output = consumer1.apply(DemoConsumerAdviceInvocator.invoke(input));
